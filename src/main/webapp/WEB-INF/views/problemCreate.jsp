...
<body>
	...
	<div class="card align-middle"
		...
		<div class="card-title" style="margin-top: 30px;">
			<h2 class="card-title text-center" style="color: #113366;">문제 작성</h2>
		</div>
		<div class="card-body">
			<form:form action="${cp}/sample/problemCreate.do" class="form-signin"
				method="POST" commandName="problemDto">
				...
				<form:textarea path="p_body" class="form-control" placeholder="문제 내용" style="height:200"/>
				<BR>
				<label for="p_answer" class="sr-only">문제 정답</label>
				<form:input path="p_answer" class="form-control" placeholder="문제 정답" />
				<br>
