...
//		}
	...
	public String doJoin(@ModelAttribute MemberDto mem, HttpServletResponse reponse) throws Exception {
		...
		if(ma.insert_user(mem)) {
			...
			System.out.println("회원가입 실패 ID or Phone 중복");
		}
	 ...
	 * request, HttpServletResponse reponse) throws Exception { //db에 회원정보 MemberDto
	 ...
	 * memberInput.jsp에 commandName이 'member'인 Member 객체를 넘겨줌 return new
